...
df = pd.read_csv("C:/Users/user/Downloads/New folder (3)/Datasets_SLR/emp_data.csv")
...
df.rename({'Salary_hike':'sh' ,'Churn_out_rate':'co' }, axis=1, inplace =True)
...
plt.subplot(1,3,1)
plt.bar(height = df['co'], x = np.arange(1, 11, 1))
plt.title('bar plot')
plt.subplot(1,3,2)
