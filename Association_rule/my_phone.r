...
arules <- apriori(qq, parameter = list(support = 0.07, confidence = .65, minlen = 2))
arules  # 8 rules
...
plot(arules[1:8], method = "graph") # for good visualization try plotting only few rules
