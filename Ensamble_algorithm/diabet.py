...
df = pd.read_csv("C://Users//user//Downloads//ensamble//Diabeted_Ensemble.csv")
...
# Input and Output Split
predictors = df1.loc[:, df1.columns!=" Class variable"]
type(predictors)

target = df1[" Class variable"]
type(target)
...
param_grid = {"max_features": [4, 5, 6, 7, 8], "min_samples_split": [2, 3, 4, 5,6,7,8],"max_leaf_nodes":[4,5,6]}
